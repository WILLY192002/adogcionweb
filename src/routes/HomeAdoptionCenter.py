...
def homeCommunity():
  ...
  if request.method == 'POST':
    ...
    My_categories = False
    My_topics = False
    My_publications = PublicationService.getAllPublicationByNaturalPerson(filter_search)
    ...
    My_categories = False
    My_topics = False
    My_publications = PublicationService.getAllPublicationByNaturalPerson(None)
    return render_template('home.html',categories = My_categories,topics = My_topics, publications = My_publications, is_adoptioncenter = False)